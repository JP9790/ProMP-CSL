...
class StandaloneDeformationController(Node):
    ...
    def train_and_generate_trajectory(self):
        ...
        if not self.train_promp():
            return False
        # Also train AIRL on same demos for reward evaluation of final execution
        self.train_airl()
    ...
    def save_final_execution_reward_to_csv(self):
        """
        Compute reward for the final execution trajectory (generated/updated by this controller)
